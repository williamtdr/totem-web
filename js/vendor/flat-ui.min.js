    ...
    !function (b, c) {
        ...
        return d = function () {
            function a(a, c) {
                ...
                }), this.$container = b("<div>", {"class": "" + this.options.baseClass + "-container"}), this.$on = b("<span>", {
            ...
            return a.prototype._constructor = a, a.prototype.state = function (a, b) {
                ...
                return this.$label.on({
                    "mousemove.bootstrapSwitch touchmove.bootstrapSwitch": function (a) {
                        return function (b) {
                            var c, d, e, f;
                            if (a.isLabelDragging)return b.preventDefault(), a.isLabelDragged = !0, d = b.pageX || b.originalEvent.touches[0].pageX, e = (d - a.$wrapper.offset().left) / a.$wrapper.width() * 100, c = 25, f = 75, a.options.animate && a.$wrapper.removeClass("" + a.options.baseClass + "-animate"), c > e ? e = c : e > f && (e = f), a.$container.css("margin-left", "" + (e - f) + "%"), a.$element.trigger("focus.bootstrapSwitch")
                        }
                    }(this), "mousedown.bootstrapSwitch touchstart.bootstrapSwitch": function (a) {
                        return function (b) {
                    ...
                    }(this), "mouseup.bootstrapSwitch touchend.bootstrapSwitch": function (a) {
                        return function (b) {
                    ...
                    }(this), "mouseleave.bootstrapSwitch": function (a) {
                        return function () {
                    ...
                    if (!k || d.options.allowDuplicates) {
                        if (!(d.items().toString().length + b.length + 1 > d.options.maxInputLength)) {
                            ...
                            if (d.$element.trigger(l), !l.cancel) {
                                ...
                                c || d.pushVal(), (d.options.maxTags === d.itemsArray.length || d.items().toString().length === d.options.maxInputLength) && d.$container.addClass("bootstrap-tagsinput-max"), d.$element.trigger(a.Event("itemAdded", {item: b}))
                            }
                        }
 ...
 */
    ...
    }(window.jQuery), /*! Video.js v4.7.3 Copyright 2014 Brightcove, Inc. https://github.com/videojs/video.js/blob/master/LICENSE */
    function () {
        function m() {
            return function () {
            }
        ...
        function t(a, b, c) {
            if ("string" == typeof a) {
                if (0 === a.indexOf("#") && (a = a.slice(1)), t.Ca[a])return t.Ca[a];
                a = t.w(a)
            }
        ...
        function D(a, b) {
            var c, d;
            c = Array.prototype.slice.call(b), d = m(), d = window.console || {
                log: d,
                warn: d,
                error: d
            }, a ? c.unshift(a.toUpperCase() + ":") : a = "log", t.log.history.push(c), c.unshift("VIDEOJS:"), d[a].apply ? d[a].apply(d, c) : d[a](c.join(" "))
        }
        ...
        function F(a, c, d, e) {
            return d !== b ? (a.b.style[c] = -1 !== ("" + d).indexOf("%") || -1 !== ("" + d).indexOf("px") ? d : "auto" === d ? "" : d + "px", e || a.m("resize"), a) : a.b ? (d = a.b.style[c], e = d.indexOf("px"), -1 !== e ? parseInt(d.slice(0, e), 10) : parseInt(a.b["offset" + t.ba(c)], 10)) : 0
        }

        function G(a) {
            var b, c, d, e, g, h, i, j;
            b = 0, c = k, a.d("touchstart", function (a) {
                ...
                e = l
            }, a.d("touchleave", g), a.d("touchcancel", g), a.d("touchend", function (a) {
                c = k, e === f && (d = (new Date).getTime() - b, 250 > d && (a.preventDefault(), this.m("tap")))
            })
        }

        function H(a, b) {
            var c, d, e, f;
            return c = a.b, d = t.xd(c), f = e = c.offsetWidth, c = a.handle, a.options().vertical ? (f = d.top, d = b.changedTouches ? b.changedTouches[0].pageY : b.pageY, c && (c = c.w().offsetHeight, f += c / 2, e -= c), Math.max(0, Math.min(1, (f - d + e) / e))) : (e = d.left, d = b.changedTouches ? b.changedTouches[0].pageX : b.pageX, c && (c = c.w().offsetWidth, e += c / 2, f -= c), Math.max(0, Math.min(1, (d - e) / f)))
        }

        function ca(a, b) {
            a.R(b), b.d("click", t.bind(a, function () {
                E(this)
            }))
        }

        function J(a) {
            a.ta = f, a.Ba.n("vjs-lock-showing"), a.b.setAttribute("aria-pressed", f), a.O && 0 < a.O.length && a.O[0].w().focus()
        }

        function I(a) {
            a.ta = l, E(a.Ba), a.b.setAttribute("aria-pressed", l)
        }

        function da(a) {
            var b = {sources: [], tracks: []};
            if (t.h.A(b, t.Aa(a)), a.hasChildNodes()) {
                var c, d, e, f;
                for (a = a.childNodes, e = 0, f = a.length; f > e; e++)c = a[e], d = c.nodeName.toLowerCase(), "source" === d ? b.sources.push(t.Aa(c)) : "track" === d && b.tracks.push(t.Aa(c))
            }
            return b
        }

        function P(a, b, c) {
            a.k && (a.ma = l, a.k.dispose(), a.k = l), "Html5" !== b && a.P && (t.g.Cb(a.P), a.P = k), a.fb = b, a.ma = l;
            var d = t.h.A({source: c, parentEl: a.b}, a.l[b.toLowerCase()]);
            c && (a.nc = c.type, c.src == a.G.src && 0 < a.G.currentTime && (d.startTime = a.G.currentTime), a.G.src = c.src), a.k = new window.videojs[b](a, d), a.k.J(function () {
                this.c.Ga()
            })
        }
        ...
        function R(a, c) {
            if (a.k && a.k.ma)try {
                ...
                throw a.k[c] === b ? t.log("Video.js: " + c + " method not defined for " + a.fb + " playback technology.", d) : "TypeError" == d.name ? (t.log("Video.js: " + c + " unavailable on " + a.fb + " playback technology element.", d), a.k.ma = l) : t.log(d), d
            }
        }

        function T(a, b) {
            var c = a.selectSource(b);
            c ? c.k === a.fb ? a.src(c.source) : P(a, c.k, c.source) : (a.error({
                code: 4,
        ...
        function fa(a) {
            a.Lb = l, a.eb(), a.p("play", a.Pc), a.p("pause", a.eb)
        }

        function ia() {
            var a = W[X], b = a.charAt(0).toUpperCase() + a.slice(1);
            ja["set" + b] = function (b) {
        ...
        function ma(a, b, c, d, e) {
            var f = a.Fa = a.Fa || [];
            e = e || {}, e.kind = b, e.label = c, e.language = d, b = t.ba(b || "subtitles");
            var g = new window.videojs[b + "Track"](a, e);
            f.push(g), g.Bb() && a.J(function () {
                setTimeout(function () {
                    Y(g.j(), g.id())
                }, 0)
            })
        ...
        function Y(a, b, c) {
            for (var d, e, f = a.Fa, g = 0, h = f.length; h > g; g++)d = f[g], d.id() === b ? (d.show(), e = d) : c && d.K() == c && 0 < d.mode() && d.disable();
            (b = e ? e.K() : c ? c : l) && a.m(b + "trackchange")
        }

        function na(a) {
            0 === a.oa && a.load(), 0 === a.na && (a.c.d("timeupdate", t.bind(a, a.update, a.U)), a.c.d("ended", t.bind(a, a.reset, a.U)), ("captions" === a.H || "subtitles" === a.H) && a.c.la("textTrackDisplay").R(a))
        }
        ...
        var b = void 0, f = !0, k = null, l = !1, s;
        document.createElement("video"), document.createElement("audio"), document.createElement("track");
        var videojs = window.videojs = t;
        t.Vb = "4.7", t.Uc = "https:" == document.location.protocol ? "https://" : "http://", t.options = {
        ...
        }, "GENERATED_CDN_VSN" !== t.Vb && (videojs.options.flash.swf = t.Uc + "vjs.zencdn.net/" + t.Vb + "/video-js.swf"), t.fd = function (a, c) {
            return t.options.languages[a] = t.options.languages[a] !== b ? t.ha.Wa(t.options.languages[a], c) : c, t.options.languages
        }, t.Ca = {}, "function" == typeof define && define.amd ? define([], function () {
            return videojs
        }) : "object" == typeof exports && "object" == typeof module && (module.exports = videojs), t.ra = t.CoreObject = m(), t.ra.extend = function (a) {
            var b, c;
            a = a || {}, b = a.init || a.i || this.prototype.init || this.prototype.i || m(), c = function () {
                b.apply(this, arguments)
            }, c.prototype = t.h.create(this.prototype), c.prototype.constructor = c, c.extend = t.ra.extend, c.create = t.ra.create;
            ...
            if (t.h.isArray(b))return u(t.d, a, b, c);
            var d = t.getData(a);
            d.D || (d.D = {}), d.D[b] || (d.D[b] = []), c.z || (c.z = t.z++), d.D[b].push(c), d.Y || (d.disabled = l, d.Y = function (b) {
                if (!d.disabled) {
                    b = t.qc(b);
                    var c = d.D[b.type];
                    if (c)for (var c = c.slice(0), e = 0, f = c.length; f > e && !b.xc(); e++)c[e].call(a, b)
                }
            }), 1 == d.D[b].length && (a.addEventListener ? a.addEventListener(b, d.Y, l) : a.attachEvent && a.attachEvent("on" + b, d.Y))
        }, t.p = function (a, b, c) {
            if (t.tc(a)) {
                var d = t.getData(a);
                if (d.D) {
                    if (t.h.isArray(b))return u(t.p, a, b, c);
                    if (b) {
                        var e = d.D[b];
                        if (e) {
                            if (c) {
                                if (c.z)for (d = 0; d < e.length; d++)e[d].z === c.z && e.splice(d--, 1)
                            } else d.D[b] = [];
                            t.kc(a, b)
                        }
                    } else for (e in d.D)b = e, d.D[b] = [], t.kc(a, b)
                }
            }
        }, t.kc = function (a, b) {
            var c = t.getData(a);
            0 === c.D[b].length && (delete c.D[b], a.removeEventListener ? a.removeEventListener(b, c.Y, l) : a.detachEvent && a.detachEvent("on" + b, c.Y)), t.Ib(c.D) && (delete c.D, delete c.Y, delete c.disabled), t.Ib(c) && t.Gc(a)
        }, t.qc = function (a) {
            function b() {
                return f
            }
            ...
            if (!a || !a.Jb) {
                ...
                if (a.target || (a.target = a.srcElement || document), a.relatedTarget = a.fromElement === a.target ? a.toElement : a.fromElement, a.preventDefault = function () {
                        d.preventDefault && d.preventDefault(), a.returnValue = l, a.Bd = b, a.defaultPrevented = f
                    }, a.Bd = c, a.defaultPrevented = l, a.stopPropagation = function () {
                        d.stopPropagation && d.stopPropagation(), a.cancelBubble = f, a.Jb = b
                    }, a.Jb = c, a.stopImmediatePropagation = function () {
                        d.stopImmediatePropagation && d.stopImmediatePropagation(), a.xc = b, a.stopPropagation()
                    }, a.xc = c, a.clientX != k) {
                ...
                a.which = a.charCode || a.keyCode, a.button != k && (a.button = 1 & a.button ? 0 : 4 & a.button ? 1 : 2 & a.button ? 2 : 0)
            }
            return a
        }, t.m = function (a, b) {
            var c = t.tc(a) ? t.getData(a) : {}, d = a.parentNode || a.ownerDocument;
            return "string" == typeof b && (b = {
                type: b,
                target: a
            }), b = t.qc(b), c.Y && c.Y.call(a, b), d && !b.Jb() && b.bubbles !== l ? t.m(d, b) : d || b.defaultPrevented || (c = t.getData(b.target), !b.target[b.type]) || (c.disabled = f, "function" == typeof b.target[b.type] && b.target[b.type](), c.disabled = l), !b.defaultPrevented
        }, t.X = function (a, b, c) {
            function d() {
                t.p(a, b, d), c.apply(this, arguments)
            }

            return t.h.isArray(b) ? u(t.X, a, b, c) : (d.z = c.z = c.z || t.z++, void t.d(a, b, d))
        };
        var v = Object.prototype.hasOwnProperty;
        t.e = function (a, b) {
            var c;
            return b = b || {}, c = document.createElement(a || "div"), t.h.Z(b, function (a, b) {
                -1 !== a.indexOf("aria-") || "role" == a ? c.setAttribute(a, b) : c[a] = b
            }), c
        }, t.ba = function (a) {
            return a.charAt(0).toUpperCase() + a.slice(1)
        }, t.h = {}, t.h.create = Object.create || function (a) {
            function b() {
            }

            return b.prototype = a, new b
        }, t.h.Z = function (a, b, c) {
            ...
            var c, d, e;
            a = t.h.copy(a);
            for (c in b)v.call(b, c) && (d = a[c], e = b[c], a[c] = t.h.Ta(d) && t.h.Ta(e) ? t.h.pd(d, e) : b[c]);
            return a
        }, t.h.copy = function (a) {
            return t.h.A({}, a)
        }, t.h.Ta = function (a) {
            ...
            return b.z || (b.z = t.z++), d.z = c ? c + "_" + b.z : b.z, d
        }, t.va = {}, t.z = 1, t.expando = "vdata" + (new Date).getTime(), t.getData = function (a) {
            var b = a[t.expando];
            return b || (b = a[t.expando] = t.z++, t.va[b] = {}), t.va[b]
        }, t.tc = function (a) {
            return a = a[t.expando], !(!a || t.Ib(t.va[a]))
        }, t.Gc = function (a) {
            var b = a[t.expando];
            if (b) {
                delete t.va[b];
        ...
        }, t.B = t.e("video"), t.M = navigator.userAgent, t.$c = /iPhone/i.test(t.M), t.Zc = /iPad/i.test(t.M), t.ad = /iPod/i.test(t.M), t.Yc = t.$c || t.Zc || t.ad;
        var aa = t, x, y = t.M.match(/OS (\d+)_/i);
        x = y && y[1] ? y[1] : b, aa.me = x, t.Wc = /Android/i.test(t.M);
        var ba = t, z, A = t.M.match(/Android (\d+)(?:\.(\d+))?(?:\.(\d+))*/i), B, C;
        A ? (B = A[1] && parseFloat(A[1]), C = A[2] && parseFloat(A[2]), z = B && C ? parseFloat(A[1] + "." + A[2]) : B ? B : k) : z = k, ba.Ub = z, t.bd = t.Wc && /webkit/i.test(t.M) && 2.3 > t.Ub, t.Xc = /Firefox/i.test(t.M), t.ne = /Chrome/i.test(t.M), t.ec = !!("ontouchstart"in window || window.Vc && document instanceof window.Vc), t.Ic = function (a, b) {
            t.h.Z(b, function (b, c) {
            ...
            if (b = {}, a && a.attributes && 0 < a.attributes.length) {
                c = a.attributes;
                for (var g = c.length - 1; g >= 0; g--)d = c[g].name, e = c[g].value, ("boolean" == typeof a[d] || -1 !== ",autoplay,controls,loop,muted,default,".indexOf("," + d + ",")) && (e = e !== k ? f : l), b[d] = e
            }
            return b
        }, t.pe = function (a, b) {
            var c = "";
            ...
            return (isNaN(a) || 1 / 0 === a) && (e = d = c = "-"), e = e > 0 || g > 0 ? e + ":" : "", e + (((e || f >= 10) && 10 > d ? "0" + d : d) + ":") + (10 > c ? "0" + c : c)
        }, t.jd = function () {
        ...
        }, t.get = function (a, b, c, d) {
            var e, g, h, i;
            c = c || m(), "undefined" == typeof XMLHttpRequest && (window.XMLHttpRequest = function () {
                try {
            ...
            }), g = new XMLHttpRequest, h = t.Vd(a), i = window.location, h.protocol + h.host === i.protocol + i.host || !window.XDomainRequest || "withCredentials"in g ? (e = "file:" == h.protocol || "file:" == i.protocol, g.onreadystatechange = function () {
                4 === g.readyState && (200 === g.status || e && 0 === g.status ? b(g.responseText) : c(g.responseText))
            }) : (g = new window.XDomainRequest, g.onload = function () {
                b(g.responseText)
            }, g.onerror = c, g.onprogress = m(), g.ontimeout = c);
            try {
            ...
            return a.match(/^https?:\/\//) || (a = t.e("div", {innerHTML: '<a href="' + a + '">x</a>'}).firstChild.href), a
        }, t.Vd = function (a) {
            var b, c, d, e;
            e = "protocol hostname port pathname search hash host".split(" "), c = t.e("a", {href: a}), (d = "" === c.host && "file:" !== c.protocol) && (b = t.e("div"), b.innerHTML = '<a href="' + a + '"></a>', c = b.firstChild, b.setAttribute("style", "display:none; position:absolute;"), document.body.appendChild(b)), a = {};
            for (var f = 0; f < e.length; f++)a[e[f]] = c[e[f]];
            return d && document.body.removeChild(b), a
        }, t.log = function () {
            D(k, arguments)
        ...
        }, t.ic = {}, t.ic.forEach = function (a, b, c) {
            if (t.h.isArray(a) && b instanceof Function)for (var d = 0, e = a.length; e > d; ++d)b.call(c || t, a[d], d, a);
            return a
        }, t.ha = {}, t.ha.Wa = function (a, b) {
            var c, d, e;
            a = t.h.copy(a);
            for (c in b)b.hasOwnProperty(c) && (d = a[c], e = b[c], a[c] = t.h.Ta(d) && t.h.Ta(e) ? t.ha.Wa(d, e) : b[c]);
            return a
        }, t.a = t.ra.extend({
            i: function (a, b, c) {
                if (this.c = a, this.l = t.h.copy(this.l), b = this.options(b), this.U = b.id || (b.el && b.el.id ? b.el.id : a.id() + "_component_" + t.z++), this.Id = b.name || k, this.b = b.el || this.e(), this.N = [], this.Qa = {}, this.Ra = {}, this.vc(), this.J(c), b.Hc !== l) {
                    var d, e;
                    d = t.bind(this.j(), this.j().reportUserActivity), this.d("touchstart", function () {
                        d(), clearInterval(e), e = setInterval(d, 250)
                    }), a = function () {
                        d(), clearInterval(e)
                    }, this.d("touchmove", d), this.d("touchend", a), this.d("touchcancel", a)
                }
            }
            ...
            this.Ra = this.Qa = this.N = k, this.p(), this.b.parentNode && this.b.parentNode.removeChild(this.b), t.Gc(this.b), this.b = k
        }, s.c = f, s.j = p("c"), s.options = function (a) {
            return a === b ? this.l : this.l = t.ha.Wa(this.l, a)
        }, s.e = function (a, b) {
            return t.e(a, b)
        }, s.s = function (a) {
            var b = this.c.language(), c = this.c.Va();
            return c && c[b] && c[b][a] ? c[b][a] : a
        }, s.w = p("b"), s.ka = function () {
            return this.v || this.b
        }, s.id = p("U"), s.name = p("Id"), s.children = p("N"), s.zd = function (a) {
            return this.Qa[a]
        }, s.la = function (a) {
            return this.Ra[a]
        }, s.R = function (a, b) {
            var c, d;
            return "string" == typeof a ? (d = a, b = b || {}, c = b.componentClass || t.ba(d), b.name = d, c = new window.videojs[c](this.c || this, b)) : c = a, this.N.push(c), "function" == typeof c.id && (this.Qa[c.id()] = c), (d = d || c.name && c.name()) && (this.Ra[d] = c), "function" == typeof c.el && c.el() && this.ka().appendChild(c.el()), c
        }, s.removeChild = function (a) {
            if ("string" == typeof a && (a = this.la(a)), a && this.N) {
                for (var b = l, c = this.N.length - 1; c >= 0; c--)if (this.N[c] === a) {
                    b = f, this.N.splice(c, 1);
                    break
                }
                b && (this.Qa[a.id] = k, this.Ra[a.name] = k, (b = a.w()) && b.parentNode === this.ka() && this.ka().removeChild(a.w()))
            }
        }, s.vc = function () {
            var a, b, c, d;
            if (a = this, b = this.options().children)if (t.h.isArray(b))for (var e = 0; e < b.length; e++)c = b[e], "string" == typeof c ? (d = c, c = {}) : d = c.name, a[d] = a.R(d, c); else t.h.Z(b, function (b, c) {
                c !== l && (a[b] = a.R(b, c))
            })
        }, s.T = r(""), s.d = function (a, b) {
            return t.d(this.b, a, t.bind(this, b)), this
        }, s.p = function (a, b) {
            return t.p(this.b, a, b), this
        }, s.X = function (a, b) {
            return t.X(this.b, a, t.bind(this, b)), this
        }, s.m = function (a) {
            return t.m(this.b, a), this
        }, s.J = function (a) {
            return a && (this.ma ? a.call(this) : (this.bb === b && (this.bb = []), this.bb.push(a))), this
        }, s.Ga = function () {
            this.ma = f;
            var a = this.bb;
            if (a && 0 < a.length) {
                for (var b = 0, c = a.length; c > b; b++)a[b].call(this);
                this.bb = [], this.m("ready")
            }
        }, s.n = function (a) {
            return t.n(this.b, a), this
        }, s.q = function (a) {
            return t.q(this.b, a), this
        }, s.show = function () {
            ...
            i: function (a, b) {
                t.a.call(this, a, b), G(this), this.d("tap", this.r), this.d("click", this.r), this.d("focus", this.Za), this.d("blur", this.Ya)
            }
        }), s = t.t.prototype, s.e = function (a, b) {
            var c;
            return b = t.h.A({
                className: this.T(),
                role: "button",
                "aria-live": "polite",
                tabIndex: 0
            }, b), c = t.a.prototype.e.call(this, a, b), b.innerHTML || (this.v = t.e("div", {className: "vjs-control-content"}), this.yb = t.e("span", {
                className: "vjs-control-text",
                innerHTML: this.s(this.ua) || "Need Text"
            }), this.v.appendChild(this.yb), c.appendChild(this.v)), c
        }, s.T = function () {
            return "vjs-control " + t.a.prototype.T.call(this)
        }, s.r = m(), s.Za = function () {
            t.d(document, "keyup", t.bind(this, this.ea))
        }, s.ea = function (a) {
            (32 == a.which || 13 == a.which) && (a.preventDefault(), this.r())
        }, s.Ya = function () {
            t.p(document, "keyup", t.bind(this, this.ea))
        }, t.Q = t.a.extend({
            i: function (a, b) {
                t.a.call(this, a, b), this.hd = this.la(this.l.barName), this.handle = this.la(this.l.handleName), this.d("mousedown", this.$a), this.d("touchstart", this.$a), this.d("focus", this.Za), this.d("blur", this.Ya), this.d("click", this.r), this.c.d("controlsvisible", t.bind(this, this.update)), a.d(this.Cc, t.bind(this, this.update)), this.S = {}, this.S.move = t.bind(this, this.ab), this.S.end = t.bind(this, this.Mb)
            }
        }), s = t.Q.prototype, s.e = function (a, b) {
            return b = b || {}, b.className += " vjs-slider", b = t.h.A({
                role: "slider",
                "aria-valuenow": 0,
                "aria-valuemin": 0,
                "aria-valuemax": 100,
                tabIndex: 0
            }, b), t.a.prototype.e.call(this, a, b)
        }, s.$a = function (a) {
            a.preventDefault(), t.jd(), this.n("vjs-sliding"), t.d(document, "mousemove", this.S.move), t.d(document, "mouseup", this.S.end), t.d(document, "touchmove", this.S.move), t.d(document, "touchend", this.S.end), this.ab(a)
        }, s.ab = m(), s.Mb = function () {
            t.ie(), this.q("vjs-sliding"), t.p(document, "mousemove", this.S.move, l), t.p(document, "mouseup", this.S.end, l), t.p(document, "touchmove", this.S.move, l), t.p(document, "touchend", this.S.end, l), this.update()
        }, s.update = function () {
            if (this.b) {
                var a, b = this.Gb(), c = this.handle, d = this.hd;
                if (isNaN(b) && (b = 0), a = b, c) {
                    a = this.b.offsetWidth;
                    var e = c.w().offsetWidth;
                    a = e ? e / a : 0, b *= 1 - a, a = b + a / 2, c.w().style.left = t.round(100 * b, 2) + "%"
                }
            ...
            37 == a.which || 40 == a.which ? (a.preventDefault(), this.Lc()) : (38 == a.which || 39 == a.which) && (a.preventDefault(), this.Mc())
        }, s.Ya = function () {
            t.p(document, "keyup", t.bind(this, this.ea))
        }, s.r = function (a) {
            a.stopImmediatePropagation(), a.preventDefault()
        }, t.$ = t.a.extend(), t.$.prototype.defaultValue = 0, t.$.prototype.e = function (a, b) {
            return b = b || {}, b.className += " vjs-slider-handle", b = t.h.A({innerHTML: '<span class="vjs-control-text">' + this.defaultValue + "</span>"}, b), t.a.prototype.e.call(this, "div", b)
        }, t.ia = t.a.extend(), t.ia.prototype.e = function () {
            var a = this.options().lc || "ul";
            return this.v = t.e(a, {className: "vjs-menu-content"}), a = t.a.prototype.e.call(this, "div", {
                append: this.v,
                className: "vjs-menu"
            }), a.appendChild(this.v), t.d(a, "click", function (a) {
                a.preventDefault(), a.stopImmediatePropagation()
            }), a
        }, t.I = t.t.extend({
            i: function (a, b) {
                t.t.call(this, a, b), this.selected(b.selected)
            }
        }), t.I.prototype.e = function (a, b) {
            return t.t.prototype.e.call(this, "li", t.h.A({className: "vjs-menu-item", innerHTML: this.l.label}, b))
            ...
            i: function (a, b) {
                t.t.call(this, a, b), this.Ba = this.xa(), this.R(this.Ba), this.O && 0 === this.O.length && this.W(), this.d("keyup", this.ea), this.b.setAttribute("aria-haspopup", f), this.b.setAttribute("role", "button")
            }
        }), s = t.L.prototype, s.ta = l, s.xa = function () {
            var a = new t.ia(this.c);
            if (this.options().title && a.ka().appendChild(t.e("li", {
                    className: "vjs-menu-title",
                    innerHTML: t.ba(this.options().title),
                    fe: -1
                })), this.O = this.createItems())for (var b = 0; b < this.O.length; b++)ca(a, this.O[b]);
            return a
        }, s.wa = m(), s.T = function () {
            return this.className + " vjs-menu-button " + t.t.prototype.T.call(this)
        }, s.Za = m(), s.Ya = m(), s.r = function () {
            this.X("mouseout", t.bind(this, function () {
                E(this.Ba), this.b.blur()
            })), this.ta ? I(this) : J(this)
        },s.ea = function (a) {
            a.preventDefault(), 32 == a.which || 13 == a.which ? this.ta ? I(this) : J(this) : 27 == a.which && this.ta && I(this)
        },t.F = function (a) {
            "number" == typeof a ? this.code = a : "string" == typeof a ? this.message = a : "object" == typeof a && t.h.A(this, a), this.message || (this.message = t.F.qd[this.code] || "")
        },t.F.prototype.code = 0,t.F.prototype.message = "",t.F.prototype.status = k,t.F.Sa = "MEDIA_ERR_CUSTOM MEDIA_ERR_ABORTED MEDIA_ERR_NETWORK MEDIA_ERR_DECODE MEDIA_ERR_SRC_NOT_SUPPORTED MEDIA_ERR_ENCRYPTED".split(" "),t.F.qd = {
        ...
        if (N)for (t.Pa.Fb = {}, O = 0; O < N.length; O++)t.Pa.Fb[M[O]] = N[O];
        t.Player = t.a.extend({
            i: function (a, b, c) {
                this.P = a, a.id = a.id || "vjs_video_" + t.z++, this.ge = a && t.Aa(a), b = t.h.A(da(a), b), this.Ua = b.language || t.options.language, this.Gd = b.languages || t.options.languages, this.G = {}, this.Dc = b.poster, this.zb = b.controls, a.controls = l, b.Hc = l, t.a.call(this, this, b, c), this.n(this.controls() ? "vjs-controls-enabled" : "vjs-controls-disabled"), t.Ca[this.U] = this, b.plugins && t.h.Z(b.plugins, function (a, b) {
                    this[a](b)
                }, this);
                var d, e, g, h, i, j;
                d = t.bind(this, this.reportUserActivity), this.d("mousedown", function () {
                    d(), clearInterval(e), e = setInterval(d, 250)
                }), this.d("mousemove", function (a) {
                    (a.screenX != i || a.screenY != j) && (i = a.screenX, j = a.screenY, d())
                }), this.d("mouseup", function () {
                    d(), clearInterval(e)
                }), this.d("keydown", d), this.d("keyup", d), g = setInterval(t.bind(this, function () {
                    this.qa && (this.qa = l, this.userActive(f), clearTimeout(h), h = setTimeout(t.bind(this, function () {
            ...
            return a === b ? this.Ua : (this.Ua = a, this)
        }, s.Va = p("Gd"), s.l = t.options, s.dispose = function () {
            this.m("dispose"), this.p("dispose"), t.Ca[this.U] = k, this.P && this.P.player && (this.P.player = k), this.b && this.b.player && (this.b.player = k), this.k && this.k.dispose(), t.a.prototype.dispose.call(this)
        }, s.e = function () {
            var a, b = this.b = t.a.prototype.e.call(this, "div"), c = this.P;
            if (c.removeAttribute("width"), c.removeAttribute("height"), c.hasChildNodes()) {
                var d, e, g, h, i;
                for (d = c.childNodes, e = d.length, i = []; e--;)g = d[e], h = g.nodeName.toLowerCase(), "track" === h && i.push(g);
                for (d = 0; d < i.length; d++)c.removeChild(i[d])
            }
            return a = t.Aa(c), t.h.Z(a, function (c) {
                b.setAttribute(c, a[c])
            }), c.id += "_html5_api", c.className = "vjs-tech", c.player = b.player = this, this.n("vjs-paused"), this.width(this.l.width, f), this.height(this.l.height, f), c.parentNode && c.parentNode.insertBefore(b, c), t.Hb(c, b), this.b = b, this.d("loadstart", this.Nd), this.d("waiting", this.Td), this.d(["canplay", "canplaythrough", "playing", "ended"], this.Sd), this.d("seeking", this.Qd), this.d("seeked", this.Pd), this.d("ended", this.Jd), this.d("play", this.Ob), this.d("firstplay", this.Ld), this.d("pause", this.Nb), this.d("progress", this.Od), this.d("durationchange", this.Ac), this.d("fullscreenchange", this.Md), b
        }, s.Nd = function () {
            this.error(k), this.paused() ? (Q(this, l), this.X("play", function () {
                Q(this, f)
            })) : this.m("firstplay")
        }, s.uc = l, s.Ob = function () {
            this.q("vjs-paused"), this.n("vjs-playing")
        }, s.Td = function () {
            this.n("vjs-waiting")
        }, s.Sd = function () {
            this.q("vjs-waiting")
            ...
            this.l.starttime && this.currentTime(this.l.starttime), this.n("vjs-has-started")
        }, s.Nb = function () {
            this.q("vjs-playing"), this.n("vjs-paused")
        }, s.Od = function () {
            ...
            a && (0 > a && (a = 1 / 0), this.duration(a), 1 / 0 === a ? this.n("vjs-live") : this.q("vjs-live"))
        }, s.Md = function () {
            this.isFullscreen() ? this.n("vjs-fullscreen") : this.q("vjs-fullscreen")
        }, s.play = function () {
            return S(this, "play"), this
        }, s.pause = function () {
            return S(this, "pause"), this
        }, s.paused = function () {
            return R(this, "paused") === l ? l : f
        }, s.currentTime = function (a) {
            return a !== b ? (S(this, "setCurrentTime", a), this) : this.G.currentTime = R(this, "currentTime") || 0
        }, s.duration = function (a) {
            return a !== b ? (this.G.duration = parseFloat(a), this) : (this.G.duration === b && this.Ac(), this.G.duration || 0)
        }, s.remainingTime = function () {
            return this.duration() - this.currentTime()
        }, s.buffered = function () {
            var a = R(this, "buffered");
            return a && a.length || (a = t.Ab(0, 0)), a
            ...
            return a !== b ? (a = Math.max(0, Math.min(1, parseFloat(a))), this.G.volume = a, S(this, "setVolume", a), t.Zd(a), this) : (a = parseFloat(R(this, "volume")), isNaN(a) ? 1 : a)
        }, s.muted = function (a) {
            return a !== b ? (S(this, "setMuted", a), this) : R(this, "muted") || l
        }, s.Ea = function () {
            return R(this, "supportsFullScreen") || l
        }, s.wc = l, s.isFullscreen = function (a) {
            ...
            var a = t.Pa.Fb;
            return this.isFullscreen(f), a ? (t.d(document, a.fullscreenchange, t.bind(this, function () {
                this.isFullscreen(document[a.fullscreenElement]), this.isFullscreen() === l && t.p(document, a.fullscreenchange, arguments.callee), this.m("fullscreenchange")
            })), this.b[a.requestFullscreen]()) : this.k.Ea() ? S(this, "enterFullScreen") : (this.pc(), this.m("fullscreenchange")), this
        }, s.exitFullscreen = function () {
            var a = t.Pa.Fb;
            return this.isFullscreen(l), a ? document[a.exitFullscreen]() : this.k.Ea() ? S(this, "exitFullScreen") : (this.Db(), this.m("fullscreenchange")), this
        }, s.pc = function () {
            this.Cd = f, this.td = document.documentElement.style.overflow, t.d(document, "keydown", t.bind(this, this.rc)), document.documentElement.style.overflow = "hidden", t.n(document.body, "vjs-full-window"), this.m("enterFullWindow")
        }, s.rc = function (a) {
            27 === a.keyCode && (this.isFullscreen() === f ? this.exitFullscreen() : this.Db())
        }, s.Db = function () {
            this.Cd = l, t.p(document, "keydown", this.rc), document.documentElement.style.overflow = this.td, t.q(document.body, "vjs-full-window"), this.m("exitFullWindow")
        }, s.selectSource = function (a) {
            for (var b = 0, c = this.l.techOrder; b < c.length; b++) {
                var d = t.ba(c[b]), e = window.videojs[d];
                if (e) {
                    if (e.isSupported())for (var f = 0, g = a; f < g.length; f++) {
                        var h = g[f];
                        if (e.canPlaySource(h))return {source: h, k: d}
                    }
                } else t.log.error('The "' + d + '" tech is undefined. Skipped browser support check for that tech.')
            }
            return l
        }, s.src = function (a) {
            return a === b ? R(this, "src") : (t.h.isArray(a) ? T(this, a) : "string" == typeof a ? this.src({src: a}) : a instanceof Object && (a.type && !window.videojs[this.fb].canPlaySource(a) ? T(this, [a]) : (this.G.src = a.src, this.nc = a.type || "", this.J(function () {
                S(this, "src", a.src), "auto" == this.l.preload && this.load(), this.l.autoplay && this.play()
            }))), this)
        }, s.load = function () {
            return S(this, "load"), this
            ...
            return a === b ? this.Dc : (this.Dc = a, S(this, "setPoster", a), void this.m("posterchange"))
        }, s.controls = function (a) {
            return a !== b ? (a = !!a, this.zb !== a && ((this.zb = a) ? (this.q("vjs-controls-disabled"), this.n("vjs-controls-enabled"), this.m("controlsenabled")) : (this.q("vjs-controls-enabled"), this.n("vjs-controls-disabled"), this.m("controlsdisabled"))), this) : this.zb
        }, t.Player.prototype.Tb, s = t.Player.prototype, s.usingNativeControls = function (a) {
            return a !== b ? (a = !!a, this.Tb !== a && ((this.Tb = a) ? (this.n("vjs-using-native-controls"), this.m("usingnativecontrols")) : (this.q("vjs-using-native-controls"), this.m("usingcustomcontrols"))), this) : this.Tb
        }, s.da = k, s.error = function (a) {
            return a === b ? this.da : a === k ? (this.da = a, this.q("vjs-error"), this) : (this.da = a instanceof t.F ? a : new t.F(a), this.m("error"), this.n("vjs-error"), t.log.error("(CODE:" + this.da.code + " " + t.F.Sa[this.da.code] + ")", this.da.message, this.da), this)
        }, s.ended = function () {
            return R(this, "ended")
        }, s.seeking = function () {
            return R(this, "seeking")
        }, s.qa = f, s.reportUserActivity = function () {
            this.qa = f
        }, s.Sb = f, s.userActive = function (a) {
            return a !== b ? (a = !!a, a !== this.Sb && ((this.Sb = a) ? (this.qa = f, this.q("vjs-user-inactive"), this.n("vjs-user-active"), this.m("useractive")) : (this.qa = l, this.k && this.k.X("mousemove", function (a) {
                a.stopPropagation(), a.preventDefault()
            }), this.q("vjs-user-active"), this.n("vjs-user-inactive"), this.m("userinactive"))), this) : this.Sb
        }, s.playbackRate = function (a) {
            return a !== b ? (S(this, "setPlaybackRate", a), this) : this.k && this.k.o && this.k.o.playbackRate ? R(this, "playbackRate") : 1
        }, t.Ja = t.a.extend(), t.Ja.prototype.l = {
            qe: "play",
            children: {
                playToggle: {},
                currentTimeDisplay: {},
            ...
            return this.v = t.e("div", {
                ...
                "aria-live": "off"
            }), a.appendChild(this.v), a
        }, t.ac = t.t.extend({
            i: function (a, b) {
                t.t.call(this, a, b), a.d("play", t.bind(this, this.Ob)), a.d("pause", t.bind(this, this.Nb))
            }
        }), s = t.ac.prototype, s.ua = "Play", s.T = function () {
            return "vjs-play-control " + t.t.prototype.T.call(this)
        }, s.r = function () {
            this.c.paused() ? this.c.play() : this.c.pause()
        }, s.Ob = function () {
            t.q(this.b, "vjs-paused"), t.n(this.b, "vjs-playing"), this.b.children[0].children[0].innerHTML = this.s("Pause")
        }, s.Nb = function () {
            t.q(this.b, "vjs-playing"), t.n(this.b, "vjs-paused"), this.b.children[0].children[0].innerHTML = this.s("Play")
        }, t.ib = t.a.extend({
            i: function (a, b) {
                t.a.call(this, a, b), a.d("timeupdate", t.bind(this, this.ga))
            }
        ...
        }), t.Ka.prototype.ua = "Fullscreen", t.Ka.prototype.T = function () {
        ...
        }), t.pb.prototype.l = {children: {seekBar: {}}}, t.pb.prototype.e = function () {
            return t.a.prototype.e.call(this, "div", {className: "vjs-progress-control vjs-control"})
        }, t.cc = t.Q.extend({
            i: function (a, b) {
                t.Q.call(this, a, b), a.d("timeupdate", t.bind(this, this.pa)), a.J(t.bind(this, this.pa))
            }
        }), s = t.cc.prototype, s.l = {
            children: {loadProgressBar: {}, playProgressBar: {}, seekHandle: {}},
            barName: "playProgressBar",
            handleName: "seekHandle"
        }, s.Cc = "timeupdate", s.e = function () {
            ...
            var a = this.c.cb ? this.c.G.currentTime : this.c.currentTime();
            this.b.setAttribute("aria-valuenow", t.round(100 * this.Gb(), 2)), this.b.setAttribute("aria-valuetext", t.za(a, this.c.duration()))
        }, s.Gb = function () {
            return this.c.currentTime() / this.c.duration()
        }, s.$a = function (a) {
            t.Q.prototype.$a.call(this, a), this.c.cb = f, this.ke = !this.c.paused(), this.c.pause()
        }, s.ab = function (a) {
            a = H(this, a) * this.c.duration(), a == this.c.duration() && (a -= .1), this.c.currentTime(a)
        }, s.Mb = function (a) {
            t.Q.prototype.Mb.call(this, a), this.c.cb = l, this.ke && this.c.play()
        },s.Mc = function () {
            ...
            i: function (a, b) {
                t.a.call(this, a, b), a.d("progress", t.bind(this, this.update))
            }
            ...
            var a, b, c, d, e = this.c.buffered();
            a = this.c.duration();
            var f, g = this.c;
            for (f = g.buffered(), g = g.duration(), f = f.end(f.length - 1), f > g && (f = g), g = this.b.children, this.b.style.width = 100 * (f / a || 0) + "%", a = 0; a < e.length; a++)b = e.start(a), c = e.end(a), (d = g[a]) || (d = this.b.appendChild(t.e())), d.style.left = 100 * (b / f || 0) + "%", d.style.width = 100 * ((c - b) / f || 0) + "%";
            ...
            i: function (a, b) {
                t.$.call(this, a, b), a.d("timeupdate", t.bind(this, this.ga))
            }
        }),t.Ma.prototype.defaultValue = "00:00",t.Ma.prototype.e = function () {
            ...
            i: function (a, b) {
                t.a.call(this, a, b), a.k && a.k.o && a.k.o.volumeControl === l && this.n("vjs-hidden"), a.d("loadstart", t.bind(this, function () {
                    a.k.o && a.k.o.volumeControl === l ? this.n("vjs-hidden") : this.q("vjs-hidden")
                }))
            }
        }),t.sb.prototype.l = {children: {volumeBar: {}}},t.sb.prototype.e = function () {
            return t.a.prototype.e.call(this, "div", {className: "vjs-volume-control vjs-control"})
        },t.rb = t.Q.extend({
            i: function (a, b) {
                t.Q.call(this, a, b), a.d("volumechange", t.bind(this, this.pa)), a.J(t.bind(this, this.pa))
            }
        }),s = t.rb.prototype,s.pa = function () {
        ...
        },t.tb = t.$.extend(),t.tb.prototype.defaultValue = "00:00",t.tb.prototype.e = function () {
            return t.$.prototype.e.call(this, "div", {className: "vjs-volume-handle"})
        },t.ja = t.t.extend({
            i: function (a, b) {
                t.t.call(this, a, b), a.d("volumechange", t.bind(this, this.update)), a.k && a.k.o && a.k.o.volumeControl === l && this.n("vjs-hidden"), a.d("loadstart", t.bind(this, function () {
                    a.k.o && a.k.o.volumeControl === l ? this.n("vjs-hidden") : this.q("vjs-hidden")
                }))
            }
        }),t.ja.prototype.e = function () {
            ...
            for (0 === a || this.c.muted() ? b = 0 : .33 > a ? b = 1 : .67 > a && (b = 2), this.c.muted() ? this.b.children[0].children[0].innerHTML != this.s("Unmute") && (this.b.children[0].children[0].innerHTML = this.s("Unmute")) : this.b.children[0].children[0].innerHTML != this.s("Mute") && (this.b.children[0].children[0].innerHTML = this.s("Mute")), a = 0; 4 > a; a++)t.q(this.b, "vjs-vol-" + a);
            t.n(this.b, "vjs-vol-" + b)
        },t.sa = t.L.extend({
            i: function (a, b) {
                t.L.call(this, a, b), a.d("volumechange", t.bind(this, this.update)), a.k && a.k.o && a.k.o.Sc === l && this.n("vjs-hidden"), a.d("loadstart", t.bind(this, function () {
                    a.k.o && a.k.o.Sc === l ? this.n("vjs-hidden") : this.q("vjs-hidden")
                })), this.n("vjs-menu-button")
            }
        }),t.sa.prototype.xa = function () {
            var a = new t.ia(this.c, {lc: "div"}), b = new t.rb(this.c, t.h.A({vertical: f}, this.l.we));
            return a.R(b), a
        },t.sa.prototype.r = function () {
            t.ja.prototype.r.call(this), t.L.prototype.r.call(this)
        },t.sa.prototype.e = function () {
            return t.t.prototype.e.call(this, "div", {
                className: "vjs-volume-menu-button vjs-menu-button vjs-control",
                innerHTML: '<div><span class="vjs-control-text">' + this.s("Mute") + "</span></div>"
            })
        },t.sa.prototype.update = t.ja.prototype.update,t.bc = t.L.extend({
            i: function (a, b) {
                t.L.call(this, a, b), this.Rc(), this.Qc(), a.d("loadstart", t.bind(this, this.Rc)), a.d("ratechange", t.bind(this, this.Qc))
            }
        }),s = t.bc.prototype,s.e = function () {
            ...
            return this.yc = t.e("div", {className: "vjs-playback-rate-value", innerHTML: 1}), a.appendChild(this.yc), a
        },s.xa = function () {
            var a = new t.ia(this.j()), b = this.j().options().playbackRates;
            if (b)for (var c = b.length - 1; c >= 0; c--)a.R(new t.ob(this.j(), {rate: b[c] + "x"}));
            return a
        },s.pa = function () {
            ...
            lc: "button", i: function (a, b) {
                var c = this.label = b.rate, d = this.Fc = parseFloat(c, 10);
                b.label = c, b.selected = 1 === d, t.I.call(this, a, b), this.j().d("ratechange", t.bind(this, this.update))
            }
        }),t.ob.prototype.r = function () {
            t.I.prototype.r.call(this), this.j().playbackRate(this.Fc)
        },t.ob.prototype.update = function () {
            this.selected(this.j().playbackRate() == this.Fc)
        },t.La = t.t.extend({
            i: function (a, b) {
                t.t.call(this, a, b), a.poster() && this.src(a.poster()), (!a.poster() || !a.controls()) && this.W(), a.d("posterchange", t.bind(this, function () {
                    this.src(a.poster())
        ...
        t.La.prototype.e = function () {
            ...
            return ea || a.appendChild(t.e("img")), a
        ...
        }, t.gb = t.t.extend(), t.gb.prototype.e = function () {
            return t.t.prototype.e.call(this, "div", {
            ...
            i: function (a, b) {
                t.a.call(this, a, b), this.update(), a.d("error", t.bind(this, this.update))
            }
        }), t.kb.prototype.e = function () {
            var a = t.a.prototype.e.call(this, "div", {className: "vjs-error-display"});
            return this.v = t.e("div"), a.appendChild(this.v), a
        }, t.kb.prototype.update = function () {
            this.j().error() && (this.v.innerHTML = this.s(this.j().error().message))
        }, t.u = t.a.extend({
            i: function (a, b, c) {
                b = b || {}, b.Hc = l, t.a.call(this, a, b, c), this.o.progressEvents || (this.zc = f, this.Ec = setInterval(t.bind(this, function () {
                    var a = this.j().bufferedPercent();
                    this.kd != a && this.j().m("progress"), this.kd = a, 1 === a && clearInterval(this.Ec)
                }), 500)), this.o.timeupdateEvents || (this.Lb = f, this.j().d("play", t.bind(this, this.Pc)), this.j().d("pause", t.bind(this, this.eb)), this.X("timeupdate", function () {
                    this.o.timeupdateEvents = f, fa(this)
                }));
                var d, e;
                e = this, d = this.j(), a = function () {
                    if (d.controls() && !d.usingNativeControls()) {
                        var a;
                        e.d("mousedown", e.r), e.d("touchstart", function () {
                            a = this.c.userActive()
                        }), e.d("touchmove", function () {
                            a && this.j().reportUserActivity()
                        }), e.d("touchend", function (a) {
                            a.preventDefault()
                        }), G(e), e.d("tap", e.Rd)
                    }
                }, b = t.bind(e, e.Xd), this.J(a), d.d("controlsenabled", a), d.d("controlsdisabled", b), this.J(function () {
                    this.networkState && 0 < this.networkState() && this.j().m("loadstart")
                })
            }
        }), s = t.u.prototype, s.Xd = function () {
            ...
            this.mc && this.eb(), this.mc = setInterval(t.bind(this, function () {
                this.j().m("timeupdate")
            }), 250)
        }, s.eb = function () {
            clearInterval(this.mc), this.j().m("timeupdate")
        }, s.dispose = function () {
            this.zc && (this.zc = l, clearInterval(this.Ec)), this.Lb && fa(this), t.a.prototype.dispose.call(this)
        }, s.Qb = function () {
            ...
            progressEvents: l,
            timeupdateEvents: l
        }, t.media = {}, t.g = t.u.extend({
            i: function (a, b, c) {
                for (this.o.volumeControl = t.g.md(), this.o.playbackRate = t.g.ld(), this.o.movingMediaElementInDOM = !t.Yc, this.o.fullscreenResize = f, this.o.progressEvents = f, t.u.call(this, a, b, c), c = t.g.lb.length - 1; c >= 0; c--)t.d(this.b, t.g.lb[c], t.bind(this, this.vd));
                if ((b = b.source) && this.b.currentSrc !== b.src && (this.b.src = b.src), t.ec && a.options().nativeControlsForTouch !== l) {
                    var d, e, g, h;
                    d = this, e = this.j(), b = e.controls(), d.b.controls = !!b, g = function () {
                        d.b.controls = f
                    }, h = function () {
                        d.b.controls = l
                    }, e.d("controlsenabled", g), e.d("controlsdisabled", h), b = function () {
                        e.p("controlsenabled", g), e.p("controlsdisabled", h)
                    }, d.d("dispose", b), e.d("usingcustomcontrols", b), e.usingNativeControls(f)
                }
                a.J(function () {
            ...
            t.g.Cb(this.b), t.u.prototype.dispose.call(this)
        }, s.e = function () {
            var a, b = this.c, c = b.P;
            c && this.o.movingMediaElementInDOM !== l || (c ? (a = c.cloneNode(l), t.g.Cb(c), c = a, b.P = k) : (c = t.e("video"), t.Ic(c, t.h.A(b.ge || {}, {
                id: b.id() + "_html5_api",
                "class": "vjs-tech"
            }))), c.player = b, t.Hb(c, b.w())), a = ["autoplay", "preload", "loop", "muted"];
            for (var d = a.length - 1; d >= 0; d--) {
                var e = a[d], f = {};
                "undefined" != typeof b.l[e] && (f[e] = b.l[e]), t.Ic(c, f)
            }
            return c
        }, s.vd = function (a) {
            ...
            return "function" != typeof this.b.webkitEnterFullScreen || !/Android/.test(t.M) && /Chrome|Mac OS X 10.5/.test(t.M) ? l : f
        }, s.oc = function () {
            var a = this.b;
            ...
            var a = t.B.volume;
            return t.B.volume = a / 2 + .1, a !== t.B.volume
        }, t.g.ld = function () {
            var a = t.B.playbackRate;
            return t.B.playbackRate = a / 2 + .1, a !== t.B.playbackRate
        };
        ...
        t.g.Bc = function () {
            ...
            return t.B.constructor.prototype.canPlayType = V, V = k, a
        }, t.g.Bc(), t.g.lb = "loadstart suspend abort error emptied stalled loadedmetadata loadeddata canplay canplaythrough playing waiting seeking seeked ended durationchange timeupdate progress play pause ratechange volumechange".split(" "), t.g.Cb = function (a) {
            if (a) {
            ...
            i: function (a, b, c) {
                ...
                var d = b.source;
                c = b.parentEl;
                var e = this.b = t.e("div", {id: a.id() + "_temp_flash"}), f = a.id() + "_flash_api", g = a.l, g = t.h.A({
                    ...
                    loop: g.loop,
                    muted: g.muted
                }, b.flashVars), h = t.h.A({wmode: "opaque", bgcolor: "#000000"}, b.params), f = t.h.A({
                    id: f,
                    name: f,
                    "class": "vjs-tech"
                }, b.attributes);
                d && (d.type && t.f.Ed(d.type) ? (d = t.f.Nc(d.src), g.rtmpConnection = encodeURIComponent(d.xb), g.rtmpStream = encodeURIComponent(d.Rb)) : g.src = encodeURIComponent(t.sc(d.src))), t.Hb(e, c), b.startTime && this.J(function () {
                    this.load(), this.play(), this.currentTime(b.startTime)
                }), t.Xc && this.J(function () {
                    t.d(this.w(), "mousemove", t.bind(this, function () {
                        this.j().m({type: "mousemove", bubbles: l})
                    }))
                }), a.d("stageclick", a.reportUserActivity), this.b = t.f.ud(b.swf, e, g, h, f)
            }
            ...
            if (t.f.Dd(a) ? (a = t.f.Nc(a), this.se(a.xb), this.te(a.Rb)) : (a = t.sc(a), this.b.vjs_src(a)), this.c.autoplay()) {
                var c = this;
                setTimeout(function () {
                    c.play()
                }, 0)
            ...
            this.Hd = a, this.b.vjs_setProperty("currentTime", a), t.u.prototype.Qb.call(this)
        ...
        }, t.f.prototype.Ea = r(l), t.f.prototype.oc = r(l);
        ...
        if (t.f.isSupported = function () {
                ...
                return a.type ? (a = a.type.replace(/;.*/, "").toLowerCase(), a in t.f.yd || a in t.f.Oc ? "maybe" : void 0) : ""
            }, t.f.yd = {
                "video/flv": "FLV",
                "video/x-flv": "FLV",
                "video/mp4": "MP4",
                "video/m4v": "MP4"
            }, t.f.Oc = {"rtmp/mp4": "MP4", "rtmp/flv": "FLV"}, t.f.onReady = function (a) {
                var b;
                (b = (a = t.w(a)) && a.parentNode && a.parentNode.player) && (a.player = b, t.f.checkReady(b.k))
                ...
                var c = t.w(a).player, d = "FLASH: " + b;
                c.error("srcnotfound" == b ? {code: 4, message: d} : d)
                ...
                return a.split(",")
            }, t.f.ud = function (a, b, c, d, e) {
                a = t.f.Ad(a, c, d, e), a = t.e("div", {innerHTML: a}).childNodes[0], c = b.parentNode, b.parentNode.replaceChild(a, b);
                var f = c.childNodes[0];
                return setTimeout(function () {
                    f.style.display = "block"
                }, 1e3), a
            }, t.f.Ad = function (a, b, c, d) {
                var e = "", f = "", g = "";
                return b && t.h.Z(b, function (a, b) {
                    e += a + "=" + b + "&amp;"
                }), c = t.h.A({
                    movie: a,
                    flashvars: e,
                    ...
                    allowNetworking: "all"
                }, c), t.h.Z(c, function (a, b) {
                    f += '<param name="' + a + '" value="' + b + '" />'
                }), d = t.h.A({data: a, width: "100%", height: "100%"}, d), t.h.Z(d, function (a, b) {
                    g += a + '="' + b + '" '
                ...
                if (!a)return b;
                var c, d = a.indexOf("&");
                return -1 !== d ? c = d + 1 : (d = c = a.lastIndexOf("/") + 1, 0 === d && (d = c = a.length)), b.xb = a.substring(0, d), b.Rb = a.substring(c, a.length), b
            }, t.f.Ed = function (a) {
                return a in t.f.Oc
            }, t.f.dd = /^rtmp[set]?:\/\//i, t.f.Dd = function (a) {
                return t.f.dd.test(a)
            }, t.cd = t.a.extend({
                i: function (a, b, c) {
                    if (t.a.call(this, a, b, c), a.l.sources && 0 !== a.l.sources.length)a.src(a.l.sources); else for (b = 0, c = a.l.techOrder; b < c.length; b++) {
                        var d = t.ba(c[b]), e = window.videojs[d];
                        if (e && e.isSupported()) {
                            P(a, d);
                            break
                ...
                i: function (a, b) {
                    t.a.call(this, a, b), this.U = b.id || "vjs_" + b.kind + "_" + b.language + "_" + t.z++, this.Kc = b.src, this.rd = b["default"] || b.dflt, this.he = b.title, this.Ua = b.srclang, this.Fd = b.label, this.ca = [], this.ub = [], this.na = this.oa = 0, this.c.d("fullscreenchange", t.bind(this, this.gd))
                }
            }), s = t.C.prototype, s.K = p("H"), s.src = p("Kc"), s.Bb = p("rd"), s.title = p("he"), s.language = p("Ua"), s.label = p("Fd"), s.nd = p("ca"), s.ed = p("ub"), s.readyState = p("oa"), s.mode = p("na"), s.gd = function () {
                ...
                na(this), this.na = 2, t.a.prototype.show.call(this)
            }, s.W = function () {
                na(this), this.na = 1, t.a.prototype.W.call(this)
            }, s.disable = function () {
                2 == this.na && this.W(), this.c.p("timeupdate", t.bind(this, this.update, this.U)), this.c.p("ended", t.bind(this, this.reset, this.U)), this.reset(), this.c.la("textTrackDisplay").removeChild(this), this.na = 0
            }, s.load = function () {
                0 === this.oa && (this.oa = 1, t.get(this.Kc, t.bind(this, this.Ud), t.bind(this, this.Kd)))
            }, s.Kd = function (a) {
                this.error = a, this.oa = 3, this.m("error")
            }, s.Ud = function (a) {
                var b, c;
                a = a.split("\n");
                for (var d = "", e = 1, f = a.length; f > e; e++)if (d = t.trim(a[e])) {
                    for (-1 == d.indexOf("-->") ? (b = d, d = t.trim(a[++e])) : b = this.ca.length, b = {
                        id: b,
                        index: this.ca.length
                    }, c = d.split(/[\t ]+/), b.startTime = oa(c[0]), b.ya = oa(c[2]), c = []; a[++e] && (d = t.trim(a[e]));)c.push(d);
                    b.text = c.join("<br/>"), this.ca.push(b)
                }
                this.oa = 2, this.m("loaded")
            }, s.update = function () {
                if (0 < this.ca.length) {
                    var a = this.c.options().trackTimeOffset || 0, a = this.c.currentTime() + a;
                    if (this.Pb === b || a < this.Pb || this.Xa <= a) {
                        var c, d, e, g, h = this.ca, i = this.c.duration(), j = 0, k = l, m = [];
                        for (a >= this.Xa || this.Xa === b ? g = this.Eb !== b ? this.Eb : 0 : (k = f, g = this.Kb !== b ? this.Kb : h.length - 1); ;) {
                            if (e = h[g], e.ya <= a)j = Math.max(j, e.ya), e.Oa && (e.Oa = l); else if (a < e.startTime) {
                                if (i = Math.min(i, e.startTime), e.Oa && (e.Oa = l), !k)break
                            } else k ? (m.splice(0, 0, e), d === b && (d = g), c = g) : (m.push(e), c === b && (c = g), d = g), i = Math.min(i, e.ya), j = Math.max(j, e.startTime), e.Oa = f;
                            if (k) {
                                if (0 === g)break;
                                g--
                            } else {
                        ...
                        for (this.ub = m, this.Xa = i, this.Pb = j, this.Eb = c, this.Kb = d, c = this.ub, d = "", a = 0, h = c.length; h > a; a++)d += '<span class="vjs-tt-cue">' + c[a].text + "</span>";
                        this.b.innerHTML = d, this.m("cuechange")
                    }
                }
            }, s.reset = function () {
                this.Xa = 0, this.Pb = this.c.duration(), this.Kb = this.Eb = 0
            }, t.Wb = t.C.extend(), t.Wb.prototype.H = "captions", t.dc = t.C.extend(), t.dc.prototype.H = "subtitles", t.Xb = t.C.extend(), t.Xb.prototype.H = "chapters", t.fc = t.a.extend({
                i: function (a, b, c) {
                    if (t.a.call(this, a, b, c), a.l.tracks && 0 < a.l.tracks.length) {
                        b = this.c, a = a.l.tracks;
                        for (var d = 0; d < a.length; d++)c = a[d], ma(b, c.kind, c.label, c.language, c)
                    }
                }
                ...
                i: function (a, b) {
                    var c = this.fa = b.track;
                    b.label = c.label(), b.selected = c.Bb(), t.I.call(this, a, b), this.c.d(c.K() + "trackchange", t.bind(this, this.update))
                }
            }), t.aa.prototype.r = function () {
                t.I.prototype.r.call(this), Y(this.c, this.fa.U, this.fa.K())
                ...
                i: function (a, b) {
                    ...
                    }, t.aa.call(this, a, b), this.selected(f)
                }
            }), t.nb.prototype.r = function () {
                t.aa.prototype.r.call(this), Y(this.c, this.fa.U, this.fa.K())
            }, t.nb.prototype.update = function () {
                for (var a, b = this.c.textTracks(), c = 0, d = b.length, e = f; d > c; c++)a = b[c], a.K() == this.fa.K() && 2 == a.mode() && (e = l);
                this.selected(e)
            }, t.V = t.L.extend({
                i: function (a, b) {
                    t.L.call(this, a, b), 1 >= this.O.length && this.W()
                }
            }), t.V.prototype.wa = function () {
                var a, b = [];
                b.push(new t.nb(this.c, {kind: this.H}));
                for (var c = 0; c < this.c.textTracks().length; c++)a = this.c.textTracks()[c], a.K() === this.H && b.push(new t.aa(this.c, {track: a}));
                return b
            }, t.Ha = t.V.extend({
                i: function (a, b, c) {
                    t.V.call(this, a, b, c), this.b.setAttribute("aria-label", "Captions Menu")
                }
            }), t.Ha.prototype.H = "captions", t.Ha.prototype.ua = "Captions", t.Ha.prototype.className = "vjs-captions-button", t.Na = t.V.extend({
                i: function (a, b, c) {
                    t.V.call(this, a, b, c), this.b.setAttribute("aria-label", "Subtitles Menu")
                }
            }), t.Na.prototype.H = "subtitles", t.Na.prototype.ua = "Subtitles", t.Na.prototype.className = "vjs-subtitles-button", t.Ia = t.V.extend({
                i: function (a, b, c) {
                    t.V.call(this, a, b, c), this.b.setAttribute("aria-label", "Chapters Menu")
                }
            }), s = t.Ia.prototype, s.H = "chapters", s.ua = "Chapters", s.className = "vjs-chapters-button", s.wa = function () {
                for (var a, b = [], c = 0; c < this.c.textTracks().length; c++)a = this.c.textTracks()[c], a.K() === this.H && b.push(new t.aa(this.c, {track: a}));
                return b
            }, s.xa = function () {
                for (var a, c, d = this.c.textTracks(), e = 0, f = d.length, g = this.O = []; f > e; e++)if (a = d[e], a.K() == this.H) {
                    if (0 !== a.readyState()) {
                        c = a;
                        break
                    }
                    a.load(), a.d("loaded", t.bind(this, this.xa))
                }
                if (d = this.Ba, d === b && (d = new t.ia(this.c), d.ka().appendChild(t.e("li", {
                        className: "vjs-menu-title",
                        innerHTML: t.ba(this.H),
                        fe: -1
                    }))), c) {
                    a = c.ca;
                    for (var h, e = 0, f = a.length; f > e; e++)h = a[e], h = new t.hb(this.c, {
                        track: c,
                        cue: h
                    }), g.push(h), d.R(h);
                    this.R(d)
                }
                return 0 < this.O.length && this.show(), d
            }, t.hb = t.I.extend({
                i: function (a, b) {
                    var c = this.fa = b.track, d = this.cue = b.cue, e = a.currentTime();
                    b.label = d.text, b.selected = d.startTime <= e && e < d.ya, t.I.call(this, a, b), c.d("cuechange", t.bind(this, this.update))
                }
                ...
                this.selected(a.startTime <= b && b < a.ya)
            }, t.h.A(t.Ja.prototype.l.children, {
                subtitlesButton: {},
                captionsButton: {},
                chaptersButton: {}
            }), "undefined" != typeof window.JSON && "function" === window.JSON.parse)t.JSON = window.JSON; else {
            t.JSON = {};
            var Z = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g;
    ...
    function w(b) {
        ...
        a.isArray(e) && (d = e, e = {results: d}), a.isFunction(e) === !1 && (d = e, e = function () {
            return d
        });
        var g = e();
    ...
    if (window.Select2 === b) {
        var E, F, G, H, I, J, K, L, M = {x: 0, y: 0}, E = {
            TAB: 9,
            ENTER: 13,
            ESC: 27,
            SPACE: 32,
        ...
        K = a(document), I = function () {
            ...
            bind: function (a) {
                ...
                }), this.propertyObserver && (this.propertyObserver.disconnect(), this.propertyObserver = null), this._sync = null, c !== b && (c.container.remove(), c.liveRegion.remove(), c.dropdown.remove(), a.removeClass("select2-offscreen").removeData("select2").off(".select2").prop("autofocus", this.autofocus || !1), this.elementTabIndex ? a.attr({tabindex: this.elementTabIndex}) : a.removeAttr("tabindex"), a.show()), C.call(this, "container", "liveRegion", "dropdown", "results", "search")
                ...
                if (e ? (c.query = this.bind(function (a) {
                        var c, e, f, g = {results: [], more: !1}, h = a.term;
                        f = function (b, c) {
                            var d;
                ...
                var b, c, d, e, f, g = this.dropdown, h = this.container.offset(), i = this.container.outerHeight(!1), j = this.container.outerWidth(!1), k = g.outerHeight(!1), l = a(window), m = l.width(), n = l.height(), o = l.scrollLeft() + m, p = l.scrollTop() + n, q = h.top + i, r = h.left, s = p >= q + k, t = h.top - k >= l.scrollTop(), u = g.outerWidth(!1), v = o >= r + u, w = g.hasClass("select2-drop-above");
            ...
            createContainer: function () {
                ...
                var b, d, e = this.container, f = this.dropdown, g = I();
            ...
            createContainer: function () {
                ...
                if (c = b.data("select2-data")) {
                    ...
                    return b.remove(), this.opts.element.trigger({
                        ...
                        val: this.id(c),
                        choice: c
                    }), this.triggerChange({removed: c}), !0
                }
            }, postprocessResults: function (a, b, c) {
            ...
            var c, d, f, g, h, i = Array.prototype.slice.call(arguments, 0), j = ["val", "destroy", "opened", "open", "close", "focus", "isFocused", "container", "dropdown", "onSortStart", "onSortEnd", "enable", "disable", "readonly", "positionDropdown", "data", "search"], k = ["opened", "isFocused", "container", "dropdown"], l = ["val", "data"], m = {search: "externalSearch"};
            return this.each(function () {
                if (0 === i.length || "object" == typeof i[0])c = 0 === i.length ? {} : a.extend({}, i[0]), c.element = a(this), "select" === c.element.get(0).tagName.toLowerCase() ? h = c.element.prop("multiple") : (h = c.multiple || !1, "tags"in c && (c.multiple = h = !0)), d = h ? new window.Select2["class"].multi : new window.Select2["class"].single, d.init(c); else {
            ...
            query: {ajax: v, local: w, tags: x},
            util: {debounce: l, markMatch: t, escapeMarkup: u, stripDiacritics: d},
            "class": {"abstract": F, single: G, multi: H}
        }
    }
}(jQuery), /*!
 ...
 */
    ...
    function c(c) {
        return this.each(function () {
            var e = b(this), f = e.data("radiocheck"), g = "object" == typeof c && c;
            if (f || "destroy" != c) {
                f || e.data("radiocheck", f = new d(this, g)), "string" == typeof c && f[c]();
    ...
    d.DEFAULTS = {
        ...
        this.$element = b(c), this.options = b.extend({}, d.DEFAULTS, this.$element.data(), e), "checkbox" == this.$element.attr("type") ? (this.$element.addClass(this.options.checkboxClass), this.$element.after(this.options.checkboxTemplate)) : "radio" == this.$element.attr("type") && (this.$element.addClass(this.options.radioClass), this.$element.after(this.options.radioTemplate))
    }, d.prototype.check = function () {
        this.$element.prop("checked", !0), this.$element.trigger("change.radiocheck").trigger("checked.radiocheck")
    }, d.prototype.uncheck = function () {
        this.$element.prop("checked", !1), this.$element.trigger("change.radiocheck").trigger("unchecked.radiocheck")
    }, d.prototype.toggle = function () {
        this.$element.prop("checked", function (a, b) {
            return !b
        }), this.$element.trigger("change.radiocheck").trigger("toggled.radiocheck")
    }, d.prototype.indeterminate = function () {
        this.$element.prop("indeterminate", !0), this.$element.trigger("change.radiocheck").trigger("indeterminated.radiocheck")
    }, d.prototype.determinate = function () {
        this.$element.prop("indeterminate", !1), this.$element.trigger("change.radiocheck").trigger("determinated.radiocheck")
    }, d.prototype.disable = function () {
        this.$element.prop("disabled", !0), this.$element.trigger("change.radiocheck").trigger("disabled.radiocheck")
    }, d.prototype.enable = function () {
        this.$element.prop("disabled", !1), this.$element.trigger("change.radiocheck").trigger("enabled.radiocheck")
    }, d.prototype.destroy = function () {
        this.$element.removeData().removeClass(this.options.checkboxClass + " " + this.options.radioClass).next(".icons").remove(), this.$element.trigger("destroyed.radiocheck")
    };
    var e = b.fn.radiocheck;
    b.fn.radiocheck = c, b.fn.radiocheck.Constructor = d, b.fn.radiocheck.noConflict = function () {
        return b.fn.radiocheck = e, this
    }
}(this, jQuery);